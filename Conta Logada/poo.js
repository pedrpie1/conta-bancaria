...
class Conta {
    constructor(nome, saldoInicial = 1000) {
        this.nome = nome; // Encapsulamento
        this.saldo = saldoInicial; // Encapsulamento
    }
...
class Usuario {
    constructor(nome) {
        this.nome = nome;
        this.conta = new Conta(nome); // Herança
    }

    realizarDeposito(valor) {
        return this.conta.depositar(valor); // Polimorfismo
    }

    realizarSaque(valor) {
        return this.conta.sacar(valor); // Polimorfismo
    }

    obterSaldo() {
        return this.conta.getSaldo(); // Polimorfismo
    }
}
